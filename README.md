...
| `6 gemm_kernel_2d_tiling_smem` | Fully tiled GEMM | 2D tiling | 🚀 High performance |
| `7 gemm_kernel_2d_tiling_smem_optimized` | Optimized tiled GEMM | Vectorization + reuse | 🚀🚀 Near-optimal |
